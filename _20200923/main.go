...
func mergeTrees_dfs(t1, t2 *TreeNode) *TreeNode {
	if t1 == nil {
		return t2
	}
	if t2 == nil {
	...
	t1.Val += t2.Val
	t1.Left = mergeTrees_dfs(t1.Left, t2.Left)
	t1.Right = mergeTrees_dfs(t1.Right, t2.Right)
	return t1
}

func mergeTrees_bfs(t1, t2 *TreeNode) *TreeNode {
	if t1 == nil {
		return t2
	}
	if t2 == nil {
